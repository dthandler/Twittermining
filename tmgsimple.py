...
class TmgSimple:
    ...
    # THIS METHOD IS CHANGED FOR THE TWEET MINING PROJECT
    def get_matrix(self, startrow, endrow, sort=True):
        ...
        return self.bag_of_words_matrix[startrow:endrow,col_order]